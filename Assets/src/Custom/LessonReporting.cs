...
public class LessonReporting : MonoBehaviour
{
	...
	void Start ()
	{
		...
		slides.Add (new Slide (
			"Your boss appreciates your work! Converting your data to make it easy to understand is not very hard. However, your work is not done. Next, you will need to create a chart of your results..."
		));
