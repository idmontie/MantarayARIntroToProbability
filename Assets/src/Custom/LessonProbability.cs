...
public class LessonProbability : MonoBehaviour
{
	...
	void Start ()
	{
		...
		slides.Add (new Slide (
			...
			"So far, we have expressed probability in the form of a percentage. However, probability can be expressed in the form of rations and fractions."
		));
		...
		slides.Add (new Slide(
			"It is much easier to multiply amounts using rations than percentages. If you wanted to make two batches of the cake recipe, you could simply multiply the ratio by two to get 6 parts flour to 2 parts milk, or 6:2."
		));
